    ...
    <span className="text-xs font-medium text-muted-foreground tracking-wide">
      Available for opportunities
        ...
        <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-bold mb-6 text-balance">
          Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Abhishek Singh</span>
        </motion.h1>

        <motion.p variants={itemVariants} className="text-xl md:text-2xl text-muted-foreground mb-8 text-balance max-w-2xl">
          DevOps Engineer & Full Stack Engineer crafting responsive, dynamic web experiences with React, JavaScript, and modern technologies.
        </motion.p>
